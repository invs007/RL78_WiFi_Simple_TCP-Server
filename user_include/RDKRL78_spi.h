...
#define LCD_SEND_RECEIVE(a,b,c)    R_CSI21_Send_Receive(a,b,c)
#define LCD_CREATE                 R_CSI21_Create
#define LCD_START 		   R_CSI21_Start

#define WIFI_SEND_RECEIVE(a,b,c)    R_CSI31_Send_Receive(a,b,c)
#define WIFI_CREATE                 R_CSI31_Create
#define WIFI_START     		    R_CSI31_Start
