...
volatile uint8_t G_SPI21_SendingData = 0;
volatile uint8_t G_SPI21_ReceivingData = 0;
volatile uint8_t G_SPI31_SendingData = 0;
volatile uint8_t G_SPI31_ReceivingData = 0;
volatile uint8_t G_IIC_SendingData = 0;
volatile uint8_t G_IIC_ReceivingData = 0;
uint8_t G_WIFI_ReceiveBuffer;
uint32_t G_WIFI_BufferIndex = 0;
/* End user code. Do not edit comment generated here */
...
__interrupt static void r_csi31_interrupt(void)
{
    ...
    {
        G_WIFI_ReceiveBuffer[G_WIFI_BufferIndex++] = SIO31;
